...
%>
 ...
 <%
	...
	//가져온 값 디버깅
	System.out.println(clientMail + "<-- updateClientForm.jsp에서 clientMail");
	System.out.println(currentPage + "<-- updateClientForm.jsp에서 currentPage");
	System.out.println(rowPerPage + "<-- updateClientForm.jsp에서 rowPerPage");
	System.out.println(searchWord + "<-- updateClientForm.jsp에서 searchWord");
 %>
