...
%>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a  href="<%=request.getContextPath()%>/category/categoryList.jsp"><i class="notika-icon notika-bar-chart"></i>상품카테고리관리</a>
                        </li>
 ...
 <%
 	//자료수집
	//보여줄 카테고리 목록 가져오기
	ArrayList<Category> categoryList = CategoryDao.selectCategory();	
 %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="normal-table-list mg-t-30">
                        ...
                        <div class="bsc-tbl-cds">
										...
										<tr>
											...
											<td>
												<form action="<%=request.getContextPath()%>/category/updateCategoryWeightAction.jsp" method="post">
													...
													<select name="categoryWeight" style="width:50px;height:22px;">
														<%
															for(int i = 0; i <=10; i++) {
											...
											<td>												
												<button type = "button" class="btn btn-secondary">		
													<a href="<%=request.getContextPath()%>/category/deleteCategoryAction.jsp?categoryName=<%=c.getCategoryName() %>">삭제</a>
												</button>												
											</td>
										</tr>
								<%		
							...
							<%
						        //카테고리 추가 가능한 관리자 레벨
						        int categoryInsertLevel = 1;
						
									//세션확인후 해당레벨 관리자만 카테고리추가 버튼이 보이게
								if( manager != null && manager.getManagerLevel() >= categoryInsertLevel  ) {
							%>
									<div style="text-align: right;">
										<button type = "button" class="btn btn-secondary"><a href = "<%=request.getContextPath()%>/category/insertCategoryForm.jsp">카테고리 추가</a></button>
									</div>
							<%
								}
							%>
