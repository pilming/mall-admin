...
%>
   ...
   <%
		...
		//값 디버깅
		System.out.println(ebookISBN + "<---ebookOne.jsp 에서 ebookISBN");
								...
								<tr>
									...
									<td>
										<a href="<%=request.getContextPath()%>/ebook/updateEbookImgForm.jsp?ebookISBN=<%=ebookOne.getEbookISBN()%>">
											<button type="button" class = "btn btn-secondary">이미지 수정</button>
										</a>
									</td>
								</tr>
								<tr>
									...
									<td>
										<a href="<%=request.getContextPath()%>/ebook/updateEbookSummaryForm.jsp?ebookISBN=<%=ebookOne.getEbookISBN()%>">
											<button type="button" class = "btn btn-secondary">책요약 수정</button>
										</a>
									</td>
								</tr>
								<tr>
